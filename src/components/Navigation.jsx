...
const Navbar = () => {
  ...
  return (
    <div className="navbar fixed top-0 left-0 p-4 z-10 bg-gradient-to-r from-gray-900 via-blue-800 to-gray-900 text-black">
      ...
      {nav ? (
        <div className="menu-items absolute top-full left-0 bg-white border border-gray-300 rounded-md shadow-md p-2 z-20 flex flex-col">
          <Link
            to="/"
            className="flex items-center text-black hover:bg-gray-100 px-4 py-2 rounded-lg font-bold text-2xl my-2"
            onClick={navHandle}
          >
