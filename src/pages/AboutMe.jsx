...
const AboutMe = () => {
  return (
    <section
      className="relative h-80 w-full mb-6 bg-cover bg-center"
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-center items-center text-center px-4">
        ...
        <p className="text-xl text-white mt-4" style={{ fontFamily: 'Montserrat, sans-serif' }}>
        ...
        {/* Add styles to other paragraphs similarly */}
      </div>
    </section>
  );
};
